...
export const TextProcessor: React.FC<TextProcessorProps> = ({
  ...
  const processedContent = React.useMemo(
    () => processContent(content, isDarkMode),
    [content, isDarkMode],
  );
      ...
      >
        <ReactMarkdown
          ...
          components={{
            ...
            ol: ({ children, ...props }) => (
              <ol
                className="list-decimal ml-6 space-y-1 break-words"
                {...props}
              >
                {children}
              </ol>
            ...
            li: ({ children, ...props }) => (
              <li
                className={`${isDarkMode ? "text-gray-100" : "text-gray-700"} break-words overflow-wrap-anywhere`}
                {...props}
              >
                {children}
              </li>
            ...
            p: ({ children, ...props }) => (
              <p
                className={`mb-2 ${isDarkMode ? "text-gray-100" : "text-gray-700"} leading-relaxed break-words overflow-wrap-anywhere`}
                {...props}
              >
                {children}
              </p>
            ...
            h4: ({ children, ...props }) => (
              <h4
                className={`text-base font-bold mb-2 ${isDarkMode ? "text-white" : "text-gray-900"}`}
                {...props}
              >
                {children}
              </h4>
            ...
            h5: ({ children, ...props }) => (
              <h5
                className={`text-sm font-bold mb-2 ${isDarkMode ? "text-white" : "text-gray-900"}`}
                {...props}
              >
                {children}
              </h5>
            ...
            h6: ({ children, ...props }) => (
              <h6
                className={`text-xs font-bold mb-2 ${isDarkMode ? "text-white" : "text-gray-900"}`}
                {...props}
              >
                {children}
              </h6>
            ...
            em: ({ children, ...props }) => (
              <em
                className={`italic ${isDarkMode ? "text-gray-100" : "text-gray-700"}`}
                {...props}
              >
                {children}
              </em>
            ...
            code: ({ children, ...props }) => (
              <code
                className={`px-1 py-0.5 rounded text-sm font-mono ${isDarkMode ? "bg-gray-800 text-gray-200" : "bg-gray-100 text-gray-800"}`}
                {...props}
              >
                {children}
              </code>
            ...
            blockquote: ({ children, ...props }) => (
              <blockquote
                className={`border-l-4 pl-4 py-2 my-4 ${isDarkMode ? "border-gray-600 bg-gray-800 text-gray-200" : "border-gray-300 bg-gray-50 text-gray-700"}`}
                {...props}
              >
                {children}
              </blockquote>

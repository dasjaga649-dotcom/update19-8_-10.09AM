...
export const ImageTestComponent: React.FC<ImageTestProps> = ({
  isDarkMode = false,
}) => {
...
For more details, contact us at [info@hutechsolutions.com](mailto:info@hutechsolutions.com)`;
  ...
  return (
    <div
      className={`space-y-8 p-6 rounded-lg border ${
    ...
    >
      ...
      <div className="space-y-4">
        ...
        >
          <ModernFileLinks fileLinks={testFileLinks} isDarkMode={isDarkMode} />
        </div>
      </div>
      ...
      >
        ...
        <ul
          className={`text-sm space-y-2 list-disc ml-4 ${
            isDarkMode ? "text-green-200" : "text-green-700"
          }`}
        >
          <li>
            <strong>Markdown Images:</strong> Render as actual images with
            proper alt text captions
          </li>
          <li>
            <strong>Markdown Links:</strong> Display as clickable text only (no
            brackets/parentheses)
          </li>
          <li>
            <strong>Image Alt Text:</strong> Used as meaningful labels, not
            "Image 1" or "Image 2"
          </li>
          <li>
            <strong>Error Handling:</strong> If image fails to load, show alt
            text with icon
          </li>
          <li>
            <strong>File Downloads:</strong> Modern cards with icons and hover
            effects
          </li>
          <li>
            <strong>Related Content:</strong> Interactive carousel with
            clickable links
          </li>
          <li>
            <strong>Extracted Images:</strong> Separate carousel showing
